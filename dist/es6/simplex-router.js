...
const defaultCompileOptions = { rules: aspNetCoreCompilers };
/**
...
class SimplexRouter {
  constructor (routeTemplates, compileOptions) {
    ...
    const options = Object.assign(
      Object.assign({}, defaultCompileOptions),
      compileOptions
    );
      ...
      for (
        ...
        if (pathForMatchVariantMatch) {
          ...
          params = Object.assign(
            Object.assign({}, templateMatchResponse.params),
            searchParams
          );
          if (typeof compiledRoute.template === 'string') {
            ...
            templateMatchResponse = Object.assign(
              Object.assign({}, compiledRoute.template),
              { params: params }
            );
          }
          if (options.onlyFirstTemplate) {
